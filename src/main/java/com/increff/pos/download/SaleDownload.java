...
import com.increff.pos.converter.SaleXmlConverter;
import com.increff.pos.fop.SaleFop;
import com.increff.pos.model.ApiException;
import com.increff.pos.xmlRootElement.SaleXmlRootElement;

public class SaleDownload {
	public static void OrderDownloadHelper(SaleXmlRootElement saleDatas,HttpServletRequest request, HttpServletResponse response) throws ApiException {
		SaleXmlConverter.jaxbObjectToXML(saleDatas);
		ByteArrayOutputStream out;
		try {
			out = SaleFop.downloadPDF();
